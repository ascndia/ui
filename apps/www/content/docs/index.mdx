...
You can use any framework that supports React. [Next.js](https://ui.ascndia.com/docs/installation/next), [Astro](https://ui.ascndia.com/docs/installation/astro), [Remix](https://ui.ascndia.com/docs/installation/remix), [Gatsby](https://ui.ascndia.com/docs/installation/gatsby) etc.
